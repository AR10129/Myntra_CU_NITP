# MyPalette - Integrating color analysis with shopping

MyPalette is an innovative application that offers personalized shopping experiences by utilizing 12 season color theory. The application allows users to upload images, detect dominant colors, and recommend clothing items based on the detected colors and user-selected filters.
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/AR10129/Myntra_CU_NITP.git
   cd MyPalette
   ```
